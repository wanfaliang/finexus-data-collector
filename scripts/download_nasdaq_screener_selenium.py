"""
Download stock list CSV from Nasdaq screener using Selenium
"""
import sys
import argparse
import logging
...
def main():
    parser = argparse.ArgumentParser(
        description='Download stock screener CSV from Nasdaq using Selenium',
...
Examples:
  ...
  python scripts/download_nasdaq_screener_selenium.py --headless

  # Specify custom output filename
  python scripts/download_nasdaq_screener_selenium.py --output nasdaq_stocks.csv

  # Custom output directory
  python scripts/download_nasdaq_screener_selenium.py --output-dir data/downloads
        """
    )
    ...
    logger.info("="*80)
    logger.info("NASDAQ STOCK SCREENER CSV DOWNLOAD (SELENIUM)")
    logger.info("="*80)
    ...
    try:
        ...
        # Download CSV
        csv_path = download_nasdaq_screener_csv_selenium(
