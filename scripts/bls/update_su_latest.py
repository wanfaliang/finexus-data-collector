#!/usr/bin/env python3
"""
Update SU (Chained Consumer Price Index - All Urban Consumers) data with latest observations from BLS API
...
def main():
    ...
    print("=" * 80)
    print("UPDATING SU (CHAINED CPI-U) DATA FROM BLS API")
    print("=" * 80)
