#!/usr/bin/env python3
"""
Update BD (Business Employment Dynamics) data with latest observations from BLS API

This script fetches the latest data points for BD series via the BLS API
and updates the database. Use this for regular quarterly updates after initial load.
...
def main():
    ...
    try:
        ...
        if data_to_upsert:
            ...
            print(f"  API requests: ~{num_requests}")
            print("\nNote: BD data for 2025 may not be available yet.")
